...
class TruthTable:
    ...
    def row(self, byte_str, tree_list):# tree_list!!
    ...
    def calculate(self, tree_list, given_list):
        ...
        while(True):
            ...
            left_expr_checking = len(new_tree_list[pl]) > 5
            right_expr_checking = len(new_tree_list[pl]) > 5

            print("********************"+" |left:"+str(pl)+"|root:"+str(q)+"|right:"+str(pr)+"| "+ "********************")

            if( left_checking and right_checking ): # UP!! 
                # can calculate
                print("(" + tree_list[pl], tree_list[q], tree_list[pr] + ") 1\n")
            ...
            elif( left_checking or right_checking ): # Down!!
                # can't calculate

                if( left_checking ): # left is operate
                    ...
                    pl = (2*pl)+1
                    print("(" + tree_list[pl], tree_list[q], tree_list[pr] + ") 2.R\n")
                ...
                pl = q
                print("(" + tree_list[pl], tree_list[q], tree_list[pr] + ") out!\n")
    ...
    def operation(self, left, root, right, tree_list, given_list):
        if( root == "!" ):
            ...
            # make exprssion for writh in truth table
            expression_form = "(" + tree_oper[left] + tree_oper[root] + tree_oper[right] + ")"
            #######
